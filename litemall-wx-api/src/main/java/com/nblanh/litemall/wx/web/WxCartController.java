...
import com.nblanh.litemall.wx.service.VipLevelService;
...
public class WxCartController {
    ...
    public Object checkout(@LoginUser Integer userId, Integer cartId, Integer addressId, Integer couponId, Integer grouponRulesId) {
        ...
        if(map.size()>0&&map.get("discount")!=null){
            discount=new BigDecimal(map.get("discount").toString());
            actualPrice = actualPrice.multiply(discount);
        }
