<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="分销等级" prop="spreadLevel"/>

      <el-table-column align="center" label="佣金比例" prop="pertage"/>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        <el-form-item label="分销等级" prop="spreadLevel">
          <el-input v-model="dataForm.spreadLevel"/>
        </el-form-item>
        <el-form-item label="佣金比例" prop="pertage">
          <el-input v-model="dataForm.pertage"/>
        </el-form-item>
      </el-form>
...
<script>
import { listVip, createVip, updateVip, deleteVip } from '@/api/spreadclass'
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        spreadLevel: [
          { required: true, message: '分销等级不能为空', trigger: 'blur' }
        ]
      },
    ...
    handleDownload() {
      this.downloadLoading = true
        import('@/vendor/Export2Excel').then(excel => {
          ...
          const filterVal = ['id', 'spreadLevel', 'pertage']
