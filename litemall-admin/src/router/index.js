...
export const asyncRouterMap = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'spreadUser',
        component: () => import('@/views/promotion/spreadUser'),
        name: 'spreadUser',
        meta: {
          perms: ['GET /admin/spreadUser/list', 'POST /admin/spreadUser/update', 'POST /admin/spreadUser/delete'],
          title: '分销用户管理',
          noCache: true
        }
      },
      {
        path: 'spreadClass',
        component: () => import('@/views/promotion/spreadClass'),
        name: 'spreadClass',
        meta: {
          perms: ['GET /admin/spreadClass/list', 'POST /admin/spreadClass/create', 'GET /admin/spreadClass/read', 'POST /admin/spreadClass/update', 'POST /admin/spreadClass/delete'],
          title: '分销等级管理',
          noCache: true
        }
      },
